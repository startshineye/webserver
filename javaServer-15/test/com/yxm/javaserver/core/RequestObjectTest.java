...
public class RequestObjectTest {
	...
	public void testGetParameters(){
		RequestObject request = new RequestObject("/oa/save?username=zs&interest=sport&interest=food");
		
		String[] parameters = request.getParameters("interest");
	   for (String string : parameters) {
		System.out.println("interest:"+string);
	   }
	    
	    String[] parameter = request.getParameters("username");
